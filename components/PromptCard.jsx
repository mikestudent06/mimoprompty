    ...
    <div className='prompt_card'>
      <div className='flex justify-between items-center gap-12'>
        <div className='flex-1 flex justify-start'>
          <Image src={post.creator.image} alt='user_image' width={40} height={40} className='rounded-full object-contain items-center gap-3 cursor-pointer'/>
        ...
        <div className='copy_btn'>
          <Image onClick={()=> handleCopy()} src={copied === post.prompt ? "/assets/icons/tick.svg" : "/assets/icons/copy.svg"} alt="copy" width={20} height={20} />
        </div>
      </div>
